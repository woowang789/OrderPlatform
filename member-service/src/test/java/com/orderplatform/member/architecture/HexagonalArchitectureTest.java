package com.orderplatform.member.architecture;
...
/**
 * Member Service 헥사고날 아키텍처 의존성 규칙 검증
 */
@AnalyzeClasses(packages = "com.orderplatform.member", importOptions = ImportOption.DoNotIncludeTests.class)
