package com.orderplatform.product.architecture;
...
/**
 * Product Service 헥사고날 아키텍처 의존성 규칙 검증
 */
@AnalyzeClasses(packages = "com.orderplatform.product", importOptions = ImportOption.DoNotIncludeTests.class)
