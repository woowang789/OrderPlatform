package com.orderplatform.payment.architecture;
...
/**
 * Payment Service 헥사고날 아키텍처 의존성 규칙 검증
 */
@AnalyzeClasses(packages = "com.orderplatform.payment", importOptions = ImportOption.DoNotIncludeTests.class)
